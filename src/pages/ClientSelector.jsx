        ...
        <Modal.Body>
          <Form>
            <Form.Group className="mb-2">
              ...
              <Form.Control value={newClient.nom} onChange={(e) => setNewClient({ ...newClient, nom: e.target.value })} />
            </Form.Group>
            <Form.Group className="mb-2">
              <Form.Label>Téléphone</Form.Label>
              <Form.Control value={newClient.telephone} onChange={(e) => setNewClient({ ...newClient, telephone: e.target.value })} />
            </Form.Group>
            <Form.Group>
              <Form.Label>Immatriculation</Form.Label>
              <Form.Control value={newClient.vehiculeImatriculation} onChange={(e) => setNewClient({ ...newClient, vehiculeImatriculation: e.target.value })} />
            </Form.Group>
          </Form>
        </Modal.Body>
        <Modal.Footer>
